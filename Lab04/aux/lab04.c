...
/*
Libera um unico bloco alocado da lista, fazendo as alteracoes necessarias
Recebe uma lista ja na posicao a ser retirada
*/
void single_free(Node **list){
...
int main(){
  ...
  char operation;
  Node *group1, *group2;
  group1 = new_node(-1);    /*Cria os headers das listas dos 2 conjuntos*/
  group2 = new_node(-1);
